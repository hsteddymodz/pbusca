...
limitarConsulta($con, $_SESSION['usuario'], 'i');
					...
					<?php }else{ ?>
		                        ...
		                        <div class="col-md-12">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Pesquisa Básica</a></li>
                                        <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">CEP</a></li>
                                        <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Nome</a></li>
                                        <li role="presentation"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab">Endereço</a></li>
                                    </ul>
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="home">
											...
											<div class="form-group col-sm-3">
												...
												<input type="text" onblur="disable_inputs(this);" onkeydown="disable_inputs(this);" onkeyup="disable_inputs(this);" name="txt_cpf" class="onlyNumbers form-control">
											</div>
											...
											<div class="form-group col-sm-3">
												...
												<input type="text" onblur="disable_inputs(this);" onkeydown="disable_inputs(this);" onkeyup="disable_inputs(this);" name="txt_placa" class=" form-control">
											</div>

											<div class="form-group col-sm-3">
												<label for="">Telefone</label>
												<input type="text" onblur="disable_inputs(this);" onkeydown="disable_inputs(this);" onkeyup="disable_inputs(this);" name="txt_fone" class="onlyNumbers form-control">
											</div>

											<div class="form-group col-sm-3">
												<label for="">E-Mail</label>
												<input type="text" onblur="disable_inputs(this);" onkeydown="disable_inputs(this);" onkeyup="disable_inputs(this);" name="txt_email" class="form-control">
											</div>
											...
											<div class="form-group text-center">
												<button type="button" onclick="do_consulta('form_basica');" name="btn_sub" value="true" class="btn btn-primary">Pesquisar</button>
											</div>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="messages">
                                        	...
                                        	<form id="form_nome" onsubmit='return verifyform(this);'>

	                                        	<div class="form-group col-sm-4">
													<label for="">Nome</label>
													<input type="text" name="txt_nome1" class=" form-control">
												</div>

												<div class="form-group col-sm-4">
													<label for="">Cidade</label>
													<input type="text" name="txt_cid1" class=" form-control">
												</div>

												<div class="form-group col-sm-4">
													<label for="">UF</label>
													<input type="text" name="txt_uf1" class=" form-control">
												</div>
												
												<div class="form-group text-center">
													<input  type='button' onclick="do_consulta('form_nome');"  class="btn btn-primary" value='Executar' id='btn_sub' name='btn_sub'>
												</div>
											</form>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="settings">
                                        	...
                                        	<form id="form_ende" action="">

                                        		<div class="form-group col-sm-4">
													<label for="">Logradouro</label>
													<input type="text" name="txt_log" class=" form-control">
												</div>

												<div class="form-group col-sm-4">
													<label for="">Número</label>
													<input type="text" name="txt_num" class=" form-control">
												</div>
												...
												<div class="form-group col-sm-4">
													...
													<input type="text" name="txt_bai" class=" form-control">
												</div>
												<div class="form-group col-sm-4">
													<label for="">Cidade</label>
													<input type="text" name="txt_cid" class=" form-control">
												</div>
												<div class="form-group col-sm-4">
													<label for="">UF</label>
													<input type="text" name="txt_uf" class=" form-control">
												</div>
												
												<div class="form-group text-center">
													<input type='button' onclick="do_consulta('form_ende');" value='Executar'  class="btn btn-primary" id='btn_sub' name='btn_sub'>
												</div>
                                ...
                                <div style="border-left:2px solid #333;" id="results2" class="col-md-8">
...
<script>
	...
	function disable_inputs(element){
		...
		$.each($('#form_basica input'), function(){
			if($(element).prop('name') != $(this).prop('name')) $(this).val("");
		});
	...
	function getdados(id, tipo = 'getdados'){
		...
		show_loading();
		var dados = "token=<?= $token; ?>&pesquisa="+tipo+"&"+tipo+"="+id;
