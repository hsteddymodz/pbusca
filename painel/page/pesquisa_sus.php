...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Pesquisa SUS</li>
		</ol>
	</div><!--/.row-->

	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Pesquisa SUS <?php if($busca) echo '<small>'.$retorno['total'].'</small>'; ?></h1>
		</div>
	</div><!--/.row-->
...
if($_POST['form']){
	...
	$codigo_consulta = registrarConsulta($con, $_SESSION['usuario'], 'sus');
...
?>
					...
					<?php if($busca){ ?>
						...
						<div class="form-group text-right">
				        	<button onclick="location.href='<?php echo URL; ?>/pesquisa_sus';" class="btn btn-default">Pesquisar Novamente</button>
				        </div>
					...
					<form action="" method="post">
						...
						<div class="form-group col-sm-3">
							...
							<input type="date" onchange="disable_inputs();" name="dataNascimento" class="form-control">
						</div>

						<div class="form-group col-sm-3">
							<label for="">CPF</label>
							<input type="text" onchange="disable_inputs();" name="cpf" class="form-control">
						</div>
...
<div class="modal fade" id="modal_sus" tabindex="-1" role="dialog">
